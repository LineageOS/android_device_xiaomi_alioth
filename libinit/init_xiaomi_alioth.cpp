...
static const variant_info_t aliothin_info = {
    ...
    .marketname = "Mi 11X",
    .model = "M2012K11AI",
    .build_fingerprint = "Mi/aliothin/aliothin:12/SKQ1.211006.001/V13.0.3.0.SKHMIXM:user/release-keys",
...
static const variant_info_t alioth_info = {
    ...
    .marketname = "K40",
    .model = "M2012K11AC",
    .build_fingerprint = "Redmi/alioth_global/alioth:12/SKQ1.211006.001/V13.0.3.0.SKHMIXM:user/release-keys",
